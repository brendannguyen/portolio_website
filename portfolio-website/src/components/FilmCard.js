...
const FilmCard = (props) => {
    return (
        <Card raised sx={{bgcolor: '#481E14', padding: '1em', '&:hover': {bgcolor: '#00224D'}, transition: 'background-color 1s'}}>
            ...
            <div style={{position: 'relative'}}><iframe frameborder="0" style={{height: '25em', maxHeight: '25em', width: '100%', borderWidth: 0, borderRadius: 1, marginTop: '0.5em'}}  src={props.src} allowfullscreen allow="autoplay; fullscreen; picture-in-picture; web-share" title="Dailymotion video player – 1e21cyro ecru"></iframe></div>
        </Card>
    )
}
